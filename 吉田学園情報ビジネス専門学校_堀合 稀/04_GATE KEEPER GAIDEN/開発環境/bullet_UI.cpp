...
CBulletUI::CBulletUI(int nPriority) : CScene2D(nPriority)
{
	...
	// アイテムによる取得出来る弾
	m_bTake[1] = CTextDataPlayer::GetUnlockInfo(CTextDataPlayer::UNLOCKDATA_WAVE);
	m_bTake[2] = CTextDataPlayer::GetUnlockInfo(CTextDataPlayer::UNLOCKDATA_MISSILE);
	m_bTake[3] = CTextDataPlayer::GetUnlockInfo(CTextDataPlayer::UNLOCKDATA_REVERSE);
