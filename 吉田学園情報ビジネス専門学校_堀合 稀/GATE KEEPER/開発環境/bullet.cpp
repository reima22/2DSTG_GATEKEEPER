...
void UpdateBullet(void)
{
	...
	// 切り替えキーで弾の装填情報の変更
	if (GetKeyboardTrigger(KEYINFO_CHANGE) == true && g_nCntType == 0 && Player->aBullet[0] == true)
	{ // 通常弾からウェーブへ
  		g_nCntType = 1;
		State = SETBULLET_WAVE;
	}
	else if(GetKeyboardTrigger(KEYINFO_CHANGE) == true && g_nCntType == 0 && Player->aBullet[0] == false && Player->aBullet[1] == true)
	{ // 通常弾からミサイルへ
		g_nCntType = 2;
		State = SETBULLET_MISSILE;
	}
	else if (GetKeyboardTrigger(KEYINFO_CHANGE) == true && g_nCntType == 0 && Player->aBullet[0] == false && Player->aBullet[1] == false && Player->aBullet[2] == true)
	{ // 通常弾からリバースウェーブへ
		g_nCntType = 3;
		State = SETBULLET_REVERSEWAVE;
	}
	else if (GetKeyboardTrigger(KEYINFO_CHANGE) == true && g_nCntType == 1 && Player->aBullet[1] == true)
	{ // ウェーブからミサイルへ
  		g_nCntType = 2;
		State = SETBULLET_MISSILE;
	}
	else if (GetKeyboardTrigger(KEYINFO_CHANGE) == true && g_nCntType == 1 && Player->aBullet[1] == false && Player->aBullet[2] == true)
	{ // ウェーブからリバースウェーブへ
		g_nCntType = 3;
		State = SETBULLET_REVERSEWAVE;
	}
	else if (GetKeyboardTrigger(KEYINFO_CHANGE) == true && g_nCntType == 1 && Player->aBullet[1] == false && Player->aBullet[2] == false)
	{ // ウェーブから通常弾へ
		g_nCntType = 0;
		State = SETBULLET_NORMAL;
	}
	else if (GetKeyboardTrigger(KEYINFO_CHANGE) == true && g_nCntType == 2 && Player->aBullet[2] == true)
	{ // ミサイルからリバースウェーブへ
		State = SETBULLET_REVERSEWAVE;
		g_nCntType = 3;
	}
	else if (GetKeyboardTrigger(KEYINFO_CHANGE) == true && g_nCntType == 2 && Player->aBullet[2] == false)
	{ // ミサイルから通常弾へ
		g_nCntType = 0;
		State = SETBULLET_NORMAL;
	}
	else if (GetKeyboardTrigger(KEYINFO_CHANGE) == true && g_nCntType == 3)
	{ // リバースウェーブから通常弾へ
		g_nCntType = 0;
		State = SETBULLET_NORMAL;
	}
